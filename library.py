...
class Lib(FloatLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.ind_pages = {1: ["'illust'", "'glaz.png'", "'[b]Медный Всадник[/b]'", "'А.С. Пушкин'", "'Иллюстрации'"],
                          ...
                          3: ["'abbook'", "'read.png'", "'[b]Медный Всадник[/b]'", "'А.С. Пушкин'", "'О памятнике'"],
                          ...
                          7: ["'vscraft'", "'glaz.png'", "'[b]Вишневый сад[/b]'", "'А.П. Чехов'", "'Спектакли'"],
                          ...
                          15: ["'readvs'", "'read.png'", "'[b]Вишневый сад[/b]'", "'А.П. Чехов'", "'Воспоминания о пьесе'"],
                          16: ["'gdesad'", "'read.png'", "'[b]Вишневый сад[/b]'", "'А.П. Чехов'", "'Реален ли сад?'"],
                          17: ["'pin7'", "'read.png'", "'[b]Преступление и наказание[/b]'", "'Ф.М. Достоевский'", "'7 секретов'"],
                          18: ["'pinfilm'", "'glaz.png'", "'[b]Преступление и наказание[/b]'", "'Ф.М. Достоевский'", "'Короткометражка'"],
                          19: ["'pinmunk'", "'read.png'", "'[b]Преступление и наказание[/b]'", "'Ф.М. Достоевский'", "'Влияние на Мунка'"],
                          20: ["'pinspek'", "'glaz.png'", "'[b]Преступление и наказание[/b]'", "'Ф.М. Достоевский'", "'Спектакль'"],
                          21: ["'pinworld'", "'read.png'", "'[b]Преступление и наказание[/b]'", "'Ф.М. Достоевский'", "'Мир Достоевского'"],
                          22: ["'pindres'", "'glaz.png'", "'[b]Преступление и наказание[/b]'", "'Ф.М. Достоевский'", "'Адреса'"]}
